...
const allTestimonials = [
  ...
  { quote: "An incredible listener who provides practical, actionable advice. My confidence has skyrocketed.", name: "Ben Carter", title: "Entrepreneur", avatar: "https://placehold.co/100x100.png", hint: "man professional", stars: 5 },
  { quote: "I was feeling stuck and overwhelmed. Now I have a clear roadmap and the motivation to follow it. Thank you!", name: "Chloe Wang", title: "Graphic Designer", avatar: "https://placehold.co/100x100.png", hint: "woman creative", stars: 5 },
  { quote: "The best investment I've made in myself. The results have been transformative, both personally and professionally.", name: "David Miller", title: "Architect", avatar: "https://placehold.co/100x100.png", hint: "professional architect", stars: 5 }
];
